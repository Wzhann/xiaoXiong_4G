...
// tuzi_SD board configuration (audio only)
...
#define POWER_OUT_GPIO GPIO_NUM_6  // 通过ADC读取电压(1V分界)，避免数字GPIO被MSPI影响
...
// Servo PWM: IO15(right ear), IO16(left ear), power controlled by IO4
#define SERVO_POWER_GPIO GPIO_NUM_4
#define SERVO_A_GPIO GPIO_NUM_15  // right ear
#define SERVO_B_GPIO GPIO_NUM_16  // left ear
#define SERVO_SWEEP_ENABLED 0  // 1 = sweep at boot, 0 = disabled

// 0 = action test mode (no AI chat), 1 = normal xiaozhi AI mode
#define XIAOZHI_CHAT_ENABLED 1
