...
//     lv_obj_set_flex_flow(top_bar_, LV_FLEX_FLOW_ROW);
//     lv_obj_set_flex_align(top_bar_, LV_FLEX_ALIGN_SPACE_BETWEEN, LV_FLEX_ALIGN_CENTER,
//     LV_FLEX_ALIGN_CENTER); lv_obj_set_scrollbar_mode(top_bar_, LV_SCROLLBAR_MODE_OFF);
...
//     LV_PART_MAIN); lv_obj_add_flag(bottom_bar_, LV_OBJ_FLAG_HIDDEN);  // Hide until there is
//     content
// #endif
...
void LcdDisplay::SetupUI() {
    xTaskCreatePinnedToCore(task_eye_update, "task_eye_update", 1024 * 4, NULL, 4,
